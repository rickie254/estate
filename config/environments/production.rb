Rails.application.configure do
  ...
  # config.active_job.queue_name_prefix = "corretor_de_imoveis_#{Rails.env}"

  # mailer
  config.action_mailer.perform_deliveries = true
  config.action_mailer.raise_delivery_errors = true
  config.action_mailer.perform_caching = false
  config.action_mailer.default_url_options = { host: 'https://zordanimoveis.herokuapp.com' }
  ...
  # for devise "The change you wanted was rejected." error prevention
